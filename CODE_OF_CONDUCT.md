...
When an incident does occur, it is important to report it promptly. To report a possible violation, **contact the maintainer privately — [@picsky](https://github.com/picsky) on GitHub, through the contact address published on that profile. Do not open a public issue, discussion, or pull request for it: the report is about a person, and that person should not read it from the tracker before the maintainer has.**

Community Moderators take reports of violations seriously and will make every effort to respond in a timely manner. They will investigate all reports of code of conduct violations, reviewing messages, logs, and recordings, or interviewing witnesses and other participants. Community Moderators will keep investigation and enforcement actions as transparent as possible while prioritizing safety and confidentiality. In order to honor these values, enforcement actions are carried out in private with the involved parties, but communicating to the whole community may be part of a mutually agreed upon resolution.

## Addressing and Repairing Harm

**This project has one maintainer, who is the Community Moderator. The ladder below is the process actually used, and it is a ladder rather than a schedule: severity decides how far down the list a case starts, and a warning is the usual first rung.** Reports are answered as soon as they are read — this is a side project, so that can be days rather than hours, and reading it is what the reporter is owed first.
