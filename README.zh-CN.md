...
2. 卡片上出现二维码
3. 用飞书扫码（或在手机上打开同一链接）
4. 卡片报「已绑定」，并列出**应用**、**接收人**、以及**长连接是否已建立**
...
48 个用例覆盖：设置命名空间与路由注册、未绑定时不升级、unbound → awaiting → bound 状态机、
